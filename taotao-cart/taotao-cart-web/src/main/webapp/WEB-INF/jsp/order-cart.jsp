...
<script type="text/javascript" src="/js/cart1.js?v=20160713"></script>
...
<body id="mainframe">
<jsp:include page="commons-order/header.jsp" />
<div class="orderMain">
	<div class="orderMain">
		<form id="orderForm" class="hide" action="/order/create.html" method="post">
			...
			<input type="hidden" name="payment" value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${(totalPrice+1000)/100 }"/>"/>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>叶朝泽&nbsp;&nbsp;&nbsp;&nbsp;177xxxxxxx&nbsp;&nbsp;&nbsp;&nbsp;泉州市&nbsp;&nbsp;鲤城区&nbsp;&nbsp;xxxxxxxxx</li>
          </ul>
        </div>
    </div>
  </div>
  ...
  <div class="backToCart"><a style=" text-decoration:underline;" target="" href="/cart/cart.html">返回修改购物车</a></div>
...
<!-- /main -->
<jsp:include page="commons-order/footer.jsp" />
</body>
</html>